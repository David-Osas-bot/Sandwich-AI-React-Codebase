...
//         features: [
//             ["check", "Purchase requests", "Create, update, track, approve, or reject procurement requests without losing the trail."],
//             ["box", "Purchase orders", "Submit POs for approval, approve or reject them, dispatch to suppliers, and track delivery progress."],
//             ["truck", "Goods received & quality control", "Record actual quantities, prices, expiry, and QC status, then finalize the GRN when the record is complete."],
//             ["coin", "Budget control", "Set budgets by procurement category, compare actual spend against them, and get alerts when thresholds are exceeded."],
//             ["chart", "Supplier performance", "Compare suppliers on delivery, spend, and quality data, and drill into individual supplier performance."],
//         ],
//         steps: [
...
export const MODULES = {
    procurement: {
        ...
        images: {
            overview: {
                key: "procurement-overview-dashboard",
                alt: "Procurement overview dashboard",
                description: "Show a clean dashboard view with procurement requests, purchase orders, delivery status, spend/budget information, and recent goods received activity."
            },
            workflow: {
                key: "procurement-workflow",
                alt: "Procurement workflow",
                description: "Show the visual progression: Request → Approval → Purchase Order → Dispatch → Delivery → GRN → Finalized."
            },
            purchaseOrder: {
                key: "purchase-order-detail-screen",
                alt: "Purchase Order detail screen",
                description: "Show supplier, ordered items, quantities, approval status, delivery progress, and PO timeline."
            },
            goodsReceived: {
                key: "grn-goods-received-screen",
                alt: "GRN / Goods Received screen",
                description: "Show a GRN matched to a purchase order, with ordered quantity vs received quantity, QC status, expiry, and price."
            },
            budgetControl: {
                key: "budget-vs-spend-dashboard",
                alt: "Budget vs Spend dashboard",
                description: "Show category budgets, actual spend, remaining budget, spend-vs-budget comparison, and budget alerts."
            },
            analytics: {
                key: "procurement-analytics-dashboard",
                alt: "Procurement analytics dashboard",
                description: "Show spend overview, spend by category, top suppliers by spend, spending trends, delivery performance, and QC statistics."
            },
            supplierPerformance: {
                key: "supplier-performance-dashboard",
                alt: "Supplier performance dashboard",
                description: "Show supplier rankings, spend by supplier, performance metrics, delivery performance, and top/bottom performers."
            },
            experiences: {
                key: "mobile-web-procurement-side-by-side",
                alt: "Mobile procurement + web procurement screens side by side",
                description: "Show a mobile procurement/request or receiving workflow alongside the desktop procurement dashboard."
            },
            dataFlow: {
                key: "connected-procurement-data-flow",
                alt: "Connected procurement data flow",
                description: "Show a simple visual connecting Request → PO → Delivery → GRN → Budget / Spend / Supplier Performance."
            }
        },
        features: [
            ["check", "Purchase requests", "Create, update, track, approve, or reject procurement requests without losing the trail."],
